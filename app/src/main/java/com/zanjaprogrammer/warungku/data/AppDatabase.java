...
@Database(entities = { Product.class, CashFlow.class, PaymentProof.class }, version = 8, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract PaymentProofDao paymentProofDao();
    ...
    // Migration from version 7 to 8: Add payment proof support
    static final Migration MIGRATION_7_8 = new Migration(7, 8) {
        @Override
        public void migrate(SupportSQLiteDatabase database) {
            // Create payment_proofs table
            database.execSQL("CREATE TABLE payment_proofs (" +
                    "id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL," +
            ...
            // Add payment proof fields to cash_flow table
            database.execSQL("ALTER TABLE cash_flow ADD COLUMN has_payment_proof INTEGER NOT NULL DEFAULT 0");
            database.execSQL("ALTER TABLE cash_flow ADD COLUMN payment_method TEXT NOT NULL DEFAULT 'CASH'");
        }
    };
