...
public class AppViewModel extends AndroidViewModel {
    ...
    public void checkoutWithPaymentMethod(String paymentMethod, boolean hasPaymentProof) {
        List<CartItem> items = cartItems.getValue();
        if (items != null && !items.isEmpty()) {
            repository.checkoutWithPaymentMethod(items, paymentMethod, hasPaymentProof);
            clearCart();
        }
    }

    public long getLastTransactionId() {
        return repository.getLastTransactionId();
    }

    public void updateTransactionPaymentProofStatus(long transactionId, boolean hasPaymentProof) {
        repository.updateTransactionPaymentProofStatus(transactionId, hasPaymentProof);
    }
    ...
    public void checkProductExists(String name, String barcode, DataRepository.ProductExistsCallback callback) {
        repository.checkProductExists(name, barcode, callback);
    }
