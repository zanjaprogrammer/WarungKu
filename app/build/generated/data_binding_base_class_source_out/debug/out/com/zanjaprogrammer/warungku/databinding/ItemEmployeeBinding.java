...
public final class ItemEmployeeBinding implements ViewBinding {
  ...
  private ItemEmployeeBinding(@NonNull MaterialCardView rootView, @NonNull MaterialButton btnRemove,
  ...
  public static ItemEmployeeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEmployeeBinding((MaterialCardView) rootView, btnRemove, tvEmail, tvName,
          tvRole);
    }
