...
public final class ItemProductSellBinding implements ViewBinding {
  @NonNull
  ...
  private ItemProductSellBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivFavorite,
  ...
  @NonNull
  public static ItemProductSellBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemProductSellBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_product_sell, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemProductSellBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductSellBinding((MaterialCardView) rootView, ivFavorite, tvProductName,
