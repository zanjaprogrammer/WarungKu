-- ============================================
-- ROW LEVEL SECURITY (RLS) SETUP (FIXED VERSION)
-- ============================================
-- Fixed version untuk menghindari error "missing FROM-clause entry for table new"
-- ============================================
...
-- Simplified: Only check if user is owner, warung_id validation done at app level
